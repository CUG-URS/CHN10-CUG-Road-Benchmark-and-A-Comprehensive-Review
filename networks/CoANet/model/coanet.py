...
from .CoANet.model.aspp import build_aspp
from .CoANet.model.decoder import build_decoder
from .CoANet.model.backbone import build_backbone
from .CoANet.model.connect import build_connect

class CoANet(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=11, num_neighbor=9,
