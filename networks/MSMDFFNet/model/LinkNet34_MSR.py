...
from .MSMDFFNet.encoder.MSENCODER import encoder_i,connecter,nonlinearity,ResidualBlock

from .MSMDFFNet.model.decoder import DecoderBlock

class LinkNet34_MSR(nn.Module):
    # 实现主module:ResNet34
    # use connector add link compare with Multi_scale_LinkNet34_1019v2
    def __init__(self, in_c=3, num_classes=1):
        super(LinkNet34_MSR, self).__init__()
        ...
        self.encoder4 = encoder_i(0.0625, in_c=layers[3], res_layers=layers[3] // 2, num_res_blocks=3, stride=2)
    ...
    def forward(self, x):
        ...
        # Decoder
        d4 = self.decoder4(e4) + self.c4(e3)   # 256*64*64
...
class LinkNet34_MSR_s(nn.Module):
    # 实现主module:ResNet34
    # 与上面的LinkNet34_MSR区别是 第四个解码器 通道数不一致
    def __init__(self, in_c=3, num_classes=1):
        super(LinkNet34_MSR_s, self).__init__()
...
class LinkNet34_MSR_s1(nn.Module):
    # 实现主module:ResNet34
    # 与上面的 LinkNet34_MSR_s 区别是 nn.MaxPool2d(3, 2, 1)
    def __init__(self, in_c=3, num_classes=1):
        super(LinkNet34_MSR_s1, self).__init__()
...
if __name__ == '__main__':
    ...
    summary(LinkNet34_MSR_s1(3).cuda(),(3,256,256))
    # summary(LinkNet34_MSR_s(3).cuda(),(3,256,256))


'''
================================================================
Total params: 36,624,033
Trainable params: 36,624,033
Non-trainable params: 0
----------------------------------------------------------------
Input size (MB): 0.75
Forward/backward pass size (MB): 775.00
Params size (MB): 139.71
Estimated Total Size (MB): 915.46
----------------------------------------------------------------
'''