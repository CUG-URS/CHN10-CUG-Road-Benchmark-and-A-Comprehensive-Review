...
from .decoder import build_decoder,build_decoder2
from .intersection import build_erase
import torch
from .dinknet import BAM_LinkNet50,BAM_LinkNet50_T,LinkNet50_T
...
class SwinT_A(nn.Module):
    def __init__(self):
        ...
        self.backboon.init_weights('swin_tiny_patch4_window7_224.pth')
